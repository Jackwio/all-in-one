...
assert_contains "assets/app.js" "Deploy 筆記"
...
assert_contains "assets/app.js" "class=\"card-title-link\""
assert_contains "assets/app.js" "const statusText = statusTextMap\\[feature.status\\];"
